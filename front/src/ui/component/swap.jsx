...
const Swap = ({poolAddress}) => {
    ...
    console.log("Swap получил poolAddress:", poolAddress);
    ...
    const swap = async (e) => {
        ...
        await servicePool.swap(amount, fromAtoB, wallet);
    }
    ...
    return (
        <Form onSubmit={swap} className="center">
            <h2> обиенять токены</h2>
            ...
            <Form.Group controlId="addliquidity">
                <Form.Label column={1}> перевести токен А?</Form.Label>
                <FormCheck/>
            </Form.Group>
